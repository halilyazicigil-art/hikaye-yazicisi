...
const pricingPlans = [
  {
    ...
    features: {
      ...
      'Sihirli Taslaklar': '3 Adet',
      'Kendi Hikayeni Yazma': 'Kapalı',
      'Hikaye Limiti': '3 Taslak/Ay',
      'Tür Seçimi': 'Sınırlı',
  ...
  },
  {
    ...
    features: {
      ...
      'Hikaye Uzunluğu': '500 Kelime',
      'Sihirli Taslaklar': '10 Adet (Premium)',
      'Kendi Hikayeni Yazma': '30 Adet/Ay',
  ...
  },
  {
    ...
    features: {
      ...
      'Bölüm Sayısı': '20 Bölüme kadar',
      'Hikaye Uzunluğu': '1000 Kelime',
      'Sihirli Taslaklar': '25 Adet (Premium)',
      'Kendi Hikayeni Yazma': '55 Adet/Ay',
      'Hikaye Limiti': '80 Masal/Ay',
      'Tür Seçimi': 'Kilidi Açıldı',
