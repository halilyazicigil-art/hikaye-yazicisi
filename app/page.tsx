...
export default async function LandingPage() {
  ...
  return (
    <main className="min-h-screen bg-[#BDD9F2] text-[#052159] overflow-x-hidden font-nunito relative">
      ...
      {/* 1. KAHRAMAN BÖLÜMÜ (Hero) - Uyuyan Çocuk Görseli Burada Kalıyor */}
      <div className="relative w-full bg-[url('/images/sleeping_child_on_clouds_hero_1778006918346.png')] bg-cover bg-center bg-no-repeat">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[#BDD9F2]"></div>
        
        <div className="relative z-10">
          <Navbar user={user} />
          
          <section className="max-w-5xl mx-auto px-6 pt-16 pb-32 text-center relative z-20">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-10">
              <a href="#create" className="bg-[#84B1D9] hover:bg-[#8FBDD9] text-white px-8 py-4 rounded-xl font-bold text-lg transition shadow-xl w-full sm:w-auto hover:scale-105">
            ...
            <div className="flex flex-wrap justify-center gap-6 text-sm font-bold text-emerald-700 mb-6 drop-shadow-md">
      ...
      {/* 2. SİHİRLİ ARKA PLANIN BAŞLADIĞI ALAN (Hero bittikten sonra) */}
      <div className="relative bg-[url('/images/whimsical-bg.png')] bg-fixed bg-cover bg-center">
        {/* Yumuşak geçiş için overlay */}
        <div className="absolute inset-0 bg-[#BDD9F2]/60 pointer-events-none"></div>

        <div className="relative z-10">
          {/* Form Section */}
          <section id="create" className="pb-20 px-4 pt-10">
          ...
          {/* Features Section */}
          <section className="max-w-7xl mx-auto px-6 py-20 border-t border-sky-900/5">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-sm border border-gray-100 flex flex-col items-center text-center">
