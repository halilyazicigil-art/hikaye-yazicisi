...
import { BookOpen, KeyRound, Mail, Loader2, Globe } from 'lucide-react'
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#F9FAFB] p-4 font-sans">
      <div className="w-full max-w-[440px]">
        ...
        <div className="text-center mb-10">
          <Link href="/" className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-white shadow-sm border border-gray-100 text-indigo-600 mb-6 hover:scale-105 transition-transform">
            <BookOpen size={28} strokeWidth={2} />
          </Link>
          <h1 className="text-2xl font-bold text-gray-900 tracking-tight">{t('auth.login.welcome')}</h1>
        ...
        <div className="bg-white rounded-[2rem] shadow-[0_1px_3px_0_rgba(0,0,0,0.1),0_1px_2px_0_rgba(0,0,0,0.06),0_20px_25px_-5px_rgba(0,0,0,0.1),0_10px_10px_-5px_rgba(0,0,0,0.04)] p-8 md:p-10 border border-gray-100">
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-4 text-gray-400 font-bold tracking-widest">{t('auth.login.or')}</span>
            </div>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="space-y-2">
              <label className="text-sm font-bold text-gray-700 ml-1">{t('auth.login.email_label')}</label>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-1">
                <label className="text-sm font-bold text-gray-700">{t('auth.login.password_label')}</label>
