...
export default function StoryPlayer({ id, title, content, imageUrl, audioUrl, pages, source, isFree }: StoryPlayerProps) {
  const { t } = useLanguage()
  ...
  }, [id, currentTrack?.id, globalProgress, getPageTimestamps, audioRef])
