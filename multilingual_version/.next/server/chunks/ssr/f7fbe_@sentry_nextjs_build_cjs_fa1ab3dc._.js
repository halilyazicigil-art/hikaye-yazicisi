module.exports = [
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/util.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/withSentryConfig/buildTime.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/withSentryConfig/deprecatedWebpackOptions.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: 'Module'
});
const util = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/util.js [app-ssr] (ecmascript)");
/**
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/getBuildPluginOptions.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/handleRunAfterProductionCompile.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
const fs = __turbopack_context__.r("[externals]/fs [external] (fs, cjs)");
const path = __turbopack_context__.r("[externals]/path [external] (path, cjs)");
const getBuildPluginOptions = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/getBuildPluginOptions.js [app-ssr] (ecmascript)");
/**
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/turbopack/generateValueInjectionRules.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
    ...
    if (Object.keys(clientValues).length > 0) {
        rules.push({
            ...
            rule: {
                ...
                loaders: [
                    {
                        loader: path.resolve(("TURBOPACK compile-time value", "/ROOT/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/turbopack"), '..', 'loaders', 'valueInjectionLoader.js'),
                        options: {
                            values: clientValues
                        }
                    }
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/turbopack/constructTurbopackConfig.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
const path = __turbopack_context__.r("[externals]/path [external] (path, cjs)");
const util = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/util.js [app-ssr] (ecmascript)");
const generateValueInjectionRules = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/turbopack/generateValueInjectionRules.js [app-ssr] (ecmascript)");
/**
    ...
    if (applicationKey && nextJsVersion && util.supportsTurbopackRuleCondition(nextJsVersion)) {
        newConfig.rules = safelyAddTurbopackRule(newConfig.rules, {
            ...
            rule: {
                ...
                loaders: [
                    {
                        loader: path.resolve(("TURBOPACK compile-time value", "/ROOT/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/turbopack"), '..', 'loaders', 'moduleMetadataInjectionLoader.js'),
                        options: {
                            applicationKey
                        }
                    }
    ...
    if (turbopackReactComponentAnnotation?.enabled && nextJsVersion && util.supportsTurbopackRuleCondition(nextJsVersion)) {
        newConfig.rules = safelyAddTurbopackRule(newConfig.rules, {
            ...
            rule: {
                ...
                loaders: [
                    {
                        loader: path.resolve(("TURBOPACK compile-time value", "/ROOT/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/turbopack"), '..', 'loaders', 'componentAnnotationLoader.js'),
                        options: {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/webpack.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
    ...
    return function newWebpackFunction(incomingConfig, buildContext) {
        ...
        if (isServer && userSentryOptions.webpack?.autoInstrumentServerFunctions !== false) {
            ...
            newConfig.module.rules.unshift({
                ...
                use: [
                    {
                        loader: path.resolve(("TURBOPACK compile-time value", "/ROOT/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config"), 'loaders', 'wrappingLoader.js'),
                        options: {
...
function addValueInjectionLoader({ newConfig, userNextConfig, userSentryOptions, buildContext, releaseName, routeManifest, nextJsVersion, vercelCronsConfig }) {
    ...
    if (buildContext.isServer) {
        newConfig.module.rules.push({
            ...
            use: [
                {
                    loader: path.resolve(("TURBOPACK compile-time value", "/ROOT/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config"), 'loaders/valueInjectionLoader.js'),
                    options: {
                        values: serverValues
                    }
                }
...
function addEdgeRuntimePolyfills(newConfig, buildContext) {
    ...
    newConfig.plugins.push(new buildContext.webpack.ProvidePlugin({
        performance: [
            path.resolve(("TURBOPACK compile-time value", "/ROOT/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config"), 'polyfills', 'perf_hooks.js'),
            'performance'
        ]
    }));
    ...
    newConfig.resolve.alias = {
        ...
        perf_hooks: path.resolve(("TURBOPACK compile-time value", "/ROOT/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config"), 'polyfills', 'perf_hooks.js')
    };
}
/**
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/withSentryConfig/constants.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/withSentryConfig/getFinalConfigObjectBundlerUtils.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: 'Module'
});
const handleRunAfterProductionCompile = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/handleRunAfterProductionCompile.js [app-ssr] (ecmascript)");
const constructTurbopackConfig = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/turbopack/constructTurbopackConfig.js [app-ssr] (ecmascript)");
const util = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/util.js [app-ssr] (ecmascript)");
const webpack = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/webpack.js [app-ssr] (ecmascript)");
const constants = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/withSentryConfig/constants.js [app-ssr] (ecmascript)");
/**
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/manifest/createRouteManifest.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/withSentryConfig/tunnel.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/withSentryConfig/getFinalConfigObjectUtils.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: 'Module'
});
const core = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/core/build/cjs/index.js [app-ssr] (ecmascript)");
const node = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/node/build/cjs/index.js [app-ssr] (ecmascript)");
const fs = __turbopack_context__.r("[externals]/fs [external] (fs, cjs)");
const path = __turbopack_context__.r("[externals]/path [external] (path, cjs)");
const createRouteManifest = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/manifest/createRouteManifest.js [app-ssr] (ecmascript)");
const util = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/util.js [app-ssr] (ecmascript)");
const buildTime = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/withSentryConfig/buildTime.js [app-ssr] (ecmascript)");
const tunnel = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/withSentryConfig/tunnel.js [app-ssr] (ecmascript)");
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/withSentryConfig/getFinalConfigObject.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
const util = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/util.js [app-ssr] (ecmascript)");
const buildTime = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/withSentryConfig/buildTime.js [app-ssr] (ecmascript)");
const deprecatedWebpackOptions = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/withSentryConfig/deprecatedWebpackOptions.js [app-ssr] (ecmascript)");
const getFinalConfigObjectBundlerUtils = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/withSentryConfig/getFinalConfigObjectBundlerUtils.js [app-ssr] (ecmascript)");
const getFinalConfigObjectUtils = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/withSentryConfig/getFinalConfigObjectUtils.js [app-ssr] (ecmascript)");
/**
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/withSentryConfig/index.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: 'Module'
});
const core = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/core/build/cjs/index.js [app-ssr] (ecmascript)");
const getFinalConfigObject = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/withSentryConfig/getFinalConfigObject.js [app-ssr] (ecmascript)");
/**
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/debug-build.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/devErrorSymbolicationEventProcessor.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: 'Module'
});
const core = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/core/build/cjs/index.js [app-ssr] (ecmascript)");
const stackTraceParser = __turbopack_context__.r("[project]/multilingual_version/node_modules/stacktrace-parser/dist/stack-trace-parser.esm.js [app-ssr] (ecmascript)");
const debugBuild = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/debug-build.js [app-ssr] (ecmascript)");
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/getVercelEnv.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/span-attributes-with-logic-attached.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/utils/isBuild.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: 'Module'
});
const constants = __turbopack_context__.r("[project]/multilingual_version/node_modules/next/constants.js [app-ssr] (ecmascript)");
/**
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/utils/responseEnd.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/utils/urls.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/utils/setUrlProcessingMetadata.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: 'Module'
});
const core = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/core/build/cjs/index.js [app-ssr] (ecmascript)");
const urls = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/utils/urls.js [app-ssr] (ecmascript)");
/**
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/server/distDirRewriteFramesIntegration.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/nextSpanAttributes.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/server/enhanceHandleRequestRootSpan.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
const core = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/core/build/cjs/index.js [app-ssr] (ecmascript)");
const nextSpanAttributes = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/nextSpanAttributes.js [app-ssr] (ecmascript)");
const spanAttributesWithLogicAttached = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/span-attributes-with-logic-attached.js [app-ssr] (ecmascript)");
/**
 ...
 */ function enhanceHandleRequestRootSpan(span) {
    ...
    if (attributes[nextSpanAttributes.ATTR_NEXT_SPAN_TYPE] !== 'BaseServer.handleRequest') {
        return;
    }
    attributes[core.SEMANTIC_ATTRIBUTE_SENTRY_OP] = 'http.server';
    ...
    // eslint-disable-next-line deprecation/deprecation
    const method = attributes[semanticConventions.SEMATTRS_HTTP_METHOD] ?? attributes[semanticConventions.ATTR_HTTP_REQUEST_METHOD];
    // eslint-disable-next-line deprecation/deprecation
    const target = attributes[semanticConventions.SEMATTRS_HTTP_TARGET];
    const route = attributes[semanticConventions.ATTR_HTTP_ROUTE] || attributes[nextSpanAttributes.ATTR_NEXT_ROUTE];
    ...
    if (typeof method === 'string' && typeof route === 'string' && !route.startsWith('middleware')) {
        ...
        attributes[nextSpanAttributes.ATTR_NEXT_ROUTE] = cleanRoute;
    }
    // backfill transaction name for pages that would otherwise contain unparameterized routes
    const routeBackfill = attributes[spanAttributesWithLogicAttached.TRANSACTION_ATTR_SENTRY_ROUTE_BACKFILL];
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/utils/addHeadersAsAttributes.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/utils/tunnelPathnameMatch.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/utils/dropMiddlewareTunnelRequests.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
const nextSpanAttributes = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/nextSpanAttributes.js [app-ssr] (ecmascript)");
const tunnelPathnameMatch = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/utils/tunnelPathnameMatch.js [app-ssr] (ecmascript)");
const spanAttributesWithLogicAttached = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/span-attributes-with-logic-attached.js [app-ssr] (ecmascript)");
const globalWithInjectedValues = core.GLOBAL_OBJ;
/**
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/utils/tracingUtils.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/server/vercelCronsMonitoring.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/server/vercelQueuesMonitoring.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/server/handleOnSpanStart.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
const opentelemetry = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/opentelemetry/build/cjs/index.js [app-ssr] (ecmascript)");
const nextSpanAttributes = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/nextSpanAttributes.js [app-ssr] (ecmascript)");
const addHeadersAsAttributes = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/utils/addHeadersAsAttributes.js [app-ssr] (ecmascript)");
const dropMiddlewareTunnelRequests = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/utils/dropMiddlewareTunnelRequests.js [app-ssr] (ecmascript)");
const tracingUtils = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/utils/tracingUtils.js [app-ssr] (ecmascript)");
const vercelCronsMonitoring = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/server/vercelCronsMonitoring.js [app-ssr] (ecmascript)");
const vercelQueuesMonitoring = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/server/vercelQueuesMonitoring.js [app-ssr] (ecmascript)");
/**
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/server/prepareSafeIdGeneratorContext.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/_error.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: 'Module'
});
const core = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/core/build/cjs/index.js [app-ssr] (ecmascript)");
const responseEnd = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/utils/responseEnd.js [app-ssr] (ecmascript)");
/**
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/utils/isUseCacheFunction.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/utils/nextSpan.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
const core = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/core/build/cjs/index.js [app-ssr] (ecmascript)");
const debugBuild = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/debug-build.js [app-ssr] (ecmascript)");
const isBuild = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/utils/isBuild.js [app-ssr] (ecmascript)");
const isUseCacheFunction = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/utils/isUseCacheFunction.js [app-ssr] (ecmascript)");
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/utils/wrapperUtils.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetStaticPropsWithSentry.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: 'Module'
});
const isBuild = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/utils/isBuild.js [app-ssr] (ecmascript)");
const wrapperUtils = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/utils/wrapperUtils.js [app-ssr] (ecmascript)");
/**
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetInitialPropsWithSentry.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapAppGetInitialPropsWithSentry.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapDocumentGetInitialPropsWithSentry.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapErrorGetInitialPropsWithSentry.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetServerSidePropsWithSentry.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/nextNavigationErrorUtils.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/wrapServerComponentWithSentry.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: 'Module'
});
const core = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/core/build/cjs/index.js [app-ssr] (ecmascript)");
const nextNavigationErrorUtils = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/nextNavigationErrorUtils.js [app-ssr] (ecmascript)");
const responseEnd = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/utils/responseEnd.js [app-ssr] (ecmascript)");
/**
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/wrapRouteHandlerWithSentry.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapApiHandlerWithSentryVercelCrons.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/wrapMiddlewareWithSentry.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapPageComponentWithSentry.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/wrapGenerationFunctionWithSentry.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/withServerActionInstrumentation.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/captureRequestError.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapApiHandlerWithSentry.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/server/index.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
const node = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/node/build/cjs/index.js [app-ssr] (ecmascript)");
const debugBuild = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/debug-build.js [app-ssr] (ecmascript)");
const devErrorSymbolicationEventProcessor = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/devErrorSymbolicationEventProcessor.js [app-ssr] (ecmascript)");
const getVercelEnv = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/getVercelEnv.js [app-ssr] (ecmascript)");
const spanAttributesWithLogicAttached = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/span-attributes-with-logic-attached.js [app-ssr] (ecmascript)");
const isBuild = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/utils/isBuild.js [app-ssr] (ecmascript)");
const responseEnd = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/utils/responseEnd.js [app-ssr] (ecmascript)");
const setUrlProcessingMetadata = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/utils/setUrlProcessingMetadata.js [app-ssr] (ecmascript)");
const distDirRewriteFramesIntegration = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/server/distDirRewriteFramesIntegration.js [app-ssr] (ecmascript)");
const enhanceHandleRequestRootSpan = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/server/enhanceHandleRequestRootSpan.js [app-ssr] (ecmascript)");
const handleOnSpanStart = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/server/handleOnSpanStart.js [app-ssr] (ecmascript)");
const prepareSafeIdGeneratorContext = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/server/prepareSafeIdGeneratorContext.js [app-ssr] (ecmascript)");
const vercelCronsMonitoring = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/server/vercelCronsMonitoring.js [app-ssr] (ecmascript)");
const vercelQueuesMonitoring = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/server/vercelQueuesMonitoring.js [app-ssr] (ecmascript)");
const _error = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/_error.js [app-ssr] (ecmascript)");
const nextSpan = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/utils/nextSpan.js [app-ssr] (ecmascript)");
const wrapGetStaticPropsWithSentry = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetStaticPropsWithSentry.js [app-ssr] (ecmascript)");
const wrapGetInitialPropsWithSentry = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetInitialPropsWithSentry.js [app-ssr] (ecmascript)");
const wrapAppGetInitialPropsWithSentry = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapAppGetInitialPropsWithSentry.js [app-ssr] (ecmascript)");
const wrapDocumentGetInitialPropsWithSentry = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapDocumentGetInitialPropsWithSentry.js [app-ssr] (ecmascript)");
const wrapErrorGetInitialPropsWithSentry = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapErrorGetInitialPropsWithSentry.js [app-ssr] (ecmascript)");
const wrapGetServerSidePropsWithSentry = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetServerSidePropsWithSentry.js [app-ssr] (ecmascript)");
const wrapServerComponentWithSentry = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/wrapServerComponentWithSentry.js [app-ssr] (ecmascript)");
const wrapRouteHandlerWithSentry = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/wrapRouteHandlerWithSentry.js [app-ssr] (ecmascript)");
const wrapApiHandlerWithSentryVercelCrons = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapApiHandlerWithSentryVercelCrons.js [app-ssr] (ecmascript)");
const wrapMiddlewareWithSentry = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/wrapMiddlewareWithSentry.js [app-ssr] (ecmascript)");
const wrapPageComponentWithSentry = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapPageComponentWithSentry.js [app-ssr] (ecmascript)");
const wrapGenerationFunctionWithSentry = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/wrapGenerationFunctionWithSentry.js [app-ssr] (ecmascript)");
const withServerActionInstrumentation = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/withServerActionInstrumentation.js [app-ssr] (ecmascript)");
const captureRequestError = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/captureRequestError.js [app-ssr] (ecmascript)");
const wrapApiHandlerWithSentry = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapApiHandlerWithSentry.js [app-ssr] (ecmascript)");
...
function init(options) {
    ...
    const opts = {
        ...
        release: ("TURBOPACK compile-time value", "e6959c34e859d66e9b1ccb9765d3193ff36e2b2e") || globalWithInjectedValues._sentryRelease,
...
"[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/index.server.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: 'Module'
});
const index$1 = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/config/withSentryConfig/index.js [app-ssr] (ecmascript)");
const index = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/server/index.js [app-ssr] (ecmascript)");
const node = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/node/build/cjs/index.js [app-ssr] (ecmascript)");
const captureRequestError = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/captureRequestError.js [app-ssr] (ecmascript)");
const _error = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/_error.js [app-ssr] (ecmascript)");
const nextSpan = __turbopack_context__.r("[project]/multilingual_version/node_modules/@sentry/nextjs/build/cjs/common/utils/nextSpan.js [app-ssr] (ecmascript)");
...
//# sourceMappingURL=f7fbe_%40sentry_nextjs_build_cjs_fa1ab3dc._.js.map