module.exports = [
"[project]/multilingual_version/.next-internal/server/app/admin/page/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
async function AdminPage({ searchParams }) {
    ...
    const [{ count: totalStories }, { count: totalUsers }, { count: activeSubsCount }, { data: recentStories, count: totalStoriesCount }, { data: errorLogs }, { data: paymentsData }] = await Promise.all([
        supabase.from('stories').select('*', {
            count: 'exact',
            head: true
        }),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f8f5f8ba._.js.map