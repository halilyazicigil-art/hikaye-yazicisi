module.exports = [
"[project]/multilingual_version/.next-internal/server/app/auth/callback/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/multilingual_version/app/auth/callback/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    if (code) {
        ...
        if (!error) {
            ...
            if ("TURBOPACK compile-time truthy", 1) {
                ...
                return __TURBOPACK__imported__module__$5b$project$5d2f$multilingual_version$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(`${origin}${next}`);
            } else //TURBOPACK unreachable
            ;
        }
    }
    // return the user to an error page with instructions
    return __TURBOPACK__imported__module__$5b$project$5d2f$multilingual_version$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(`${origin}/login?error=auth-callback-error`);
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__7cf40d7d._.js.map